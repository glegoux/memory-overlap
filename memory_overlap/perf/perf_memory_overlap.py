...
def trace_perf(pathname, img_path, title=''):
...
if __name__ == "__main__":
    ...
    naive_share_memory = timeit()(mo.share_memory)
    ...
    # variant n_elts
    range_perf(mo.share_memory, max_n=10 ** 6, step=10 ** 5, unity='ms',
               output='../output/naive_perf_n_elts.csv')
    trace_perf('../output/naive_perf_n_elts.csv', '../output/naive_perf_n_elts.jpg')
    range_perf(np.shares_memory, max_n=10 ** 6, step=10 ** 5, unity='ns',
               output='../output/np_perf_n_elts.csv')
    trace_perf('../output/np_perf_n_elts.csv', '../output/np_perf_n_elts.jpg')

    # variant n_dims
    range_perf(mo.share_memory, max_n=12, step=1, get_arrays=high_dim,
               title_axis='n_dims', unity='ms',
               output='../output/naive_perf_n_dims.csv')
    trace_perf('../output/naive_perf_n_dims.csv', '../output/naive_perf_n_dims.jpg')
    range_perf(np.shares_memory, max_n=12, step=1, get_arrays=high_dim,
               title_axis='n_dims', unity='ns',
               output='../output/np_perf_n_dims.csv')
    trace_perf('../output/np_perf_n_dims.csv', '../output/np_perf_n_dims.jpg')
